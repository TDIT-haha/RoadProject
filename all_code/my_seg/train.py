...
dir_img = Path('/media/root/fc6cf683-9c07-46ff-a325-9115b0701844/root/LIKE/电路板定位/img')
dir_mask = Path('/media/root/fc6cf683-9c07-46ff-a325-9115b0701844/root/LIKE/电路板定位/json2mask/masks')
...
def train_net(net,
    ...
    for epoch in range(1, epochs+1):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch}/{epochs}', unit='img') as pbar:
            ...
            if epoch % 3 == 0:
                val_score = evaluate(net, val_loader, device,args.classes)
...
def get_args():
    ...
    parser.add_argument('--epochs', '-e', metavar='E', type=int, default=900, help='Number of epochs')
